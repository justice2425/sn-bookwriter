...
`}function R(e){let t=e||new Date,n=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${n}-${o}-${a}`}function dt(e,t,n){let o=Object.assign({},e||{}),a=n||R();return(!o.session||o.session.date!==a||typeof o.session.startWords!="number")&&(o.session={date:a,startWords:t}),o}function Nt(e,t,n){let o=n||R();return e&&e.session&&e.session.date===o&&typeof e.session.startWords=="number"?Math.max(0,t-e.session.startWords):0}var u=q(),b={},f={},mt=null,K=!1,v=!1,de=250,l=e=>document.querySelector(e),m=(e,t={},n=[])=>{let o=document.createElement(e);for(let a in t)a==="class"?o.className=t[a]:a==="html"?o.innerHTML=t[a]:a.startsWith("on")&&typeof t[a]=="function"?o.addEventListener(a.slice(2),t[a]):o.setAttribute(a,t[a]);for(let a of[].concat(n))o.appendChild(typeof a=="string"?document.createTextNode(a):a);return o};function k(){let e=u.chapters.find(t=>t.id===u.activeId)||u.chapters[0];return e&&!Array.isArray(e.footnotes)&&(e.footnotes=[]),e}var G=null;function y(){v||(G&&clearTimeout(G),G=setTimeout(Pt,400))}function Pt(){G=null;let e=rt(u);mt=e,w.default.text=e;let t=k(),n=W(t?t.html:"").slice(0,90)||t?.title||"Manuscript";w.default.preview=n}function Ft(){v||(w.default.meta=b)}function vt(){w.default.extensionMeta=f}function qt(){E(),Y(),I(),wt(),xt()}function E(){let e=l("#chapter-list");e.innerHTML="",u.chapters.forEach((t,n)=>{let o=J(t),a=m("div",{class:"chapter-row"+(t.id===u.activeId?" active":""),draggable:v?"false":"true","data-id":t.id});a.appendChild(m("span",{class:"chapter-name"},t.title||"Untitled")),a.appendChild(m("span",{class:"chapter-words"},String(o))),a.addEventListener("click",i=>{i.target.closest(".row-actions")||pe(t.id)});let s=m("div",{class:"row-actions"});v||(s.appendChild(m("button",{class:"icon-btn",title:"Rename",onclick:i=>{i.stopPropagation(),fe(t.id)}},"\u270E")),s.appendChild(m("button",{class:"icon-btn",title:"Move up",onclick:i=>{i.stopPropagation(),Rt(n,-1)}},"\u2191")),s.appendChild(m("button",{class:"icon-btn",title:"Move down",onclick:i=>{i.stopPropagation(),Rt(n,1)}},"\u2193")),s.appendChild(m("button",{class:"icon-btn danger",title:"Delete",onclick:i=>{i.stopPropagation(),he(t.id)}},"\u{1F5D1}"))),a.appendChild(s),v||(a.addEventListener("dragstart",i=>{U=t.id,a.classList.add("dragging"),i.dataTransfer.effectAllowed="move"}),a.addEventListener("dragend",()=>{U=null,a.classList.remove("dragging")}),a.addEventListener("dragover",i=>{i.preventDefault(),a.classList.add("drag-over")}),a.addEventListener("dragleave",()=>a.classList.remove("drag-over")),a.addEventListener("drop",i=>{i.preventDefault(),a.classList.remove("drag-over"),ue(t.id)})),e.appendChild(a)}),l("#total-words").textContent=N(u).toLocaleString()}var U=null;function ue(e){if(!U||U===e)return;let t=u.chapters.findIndex(a=>a.id===U),n=u.chapters.findIndex(a=>a.id===e);if(t<0||n<0)return;let[o]=u.chapters.splice(t,1);u.chapters.splice(n,0,o),E(),y()}function pe(e){e!==u.activeId&&(S(),u.activeId=e,E(),Y(),y(),Z())}function me(){S();let e=A();u.chapters.push({id:e,title:`Chapter ${u.chapters.length+1}`,html:""}),u.activeId=e,E(),Y(),y(),Z()}function fe(e){let t=u.chapters.find(o=>o.id===e);if(!t)return;let n=window.prompt("Chapter title:",t.title);n!=null&&(t.title=n.trim()||t.title,E(),I(),y())}function Rt(e,t){let n=e+t;if(n<0||n>=u.chapters.length)return;let o=u.chapters;[o[e],o[n]]=[o[n],o[e]],E(),y()}function he(e){if(u.chapters.length===1){window.alert("A manuscript needs at least one chapter.");return}let t=u.chapters.find(o=>o.id===e);if(!window.confirm(`Delete "${t?t.title:"chapter"}"? This cannot be undone.`))return;let n=u.chapters.findIndex(o=>o.id===e);u.chapters.splice(n,1),u.activeId===e&&(u.activeId=u.chapters[Math.max(0,n-1)].id),E(),Y(),I(),y()}var h=()=>l("#editor");function Y(){let e=k(),t=h();t.innerHTML=e&&e.html?e.html:"<p><br></p>",l("#chapter-title-input").value=e?e.title:"",t.contentEditable=v?"false":"true",V(),H(),S(),X(),I(),setTimeout(P,0)}function S(){let e=k();e&&(e.html=h().innerHTML)}function L(){V(),H(),S(),X(),I(),ge(),y(),f.focusMode&&Ct()}function ge(){document.querySelectorAll(".chapter-row").forEach(t=>{let n=t.getAttribute("data-id"),o=u.chapters.find(a=>a.id===n);o&&(t.querySelector(".chapter-words").textContent=String(J(o)))}),l("#total-words").textContent=N(u).toLocaleString()}function O(e,t=null){v||(h().focus(),document.execCommand(e,!1,t),L())}function Z(){let e=h();e.focus();let t=document.createRange();t.selectNodeContents(e),t.collapse(!1);let n=window.getSelection();n.removeAllRanges(),n.addRange(t)}function be(e){if(!v)switch(e){case"indent":ft(1);break;case"outdent":ft(-1);break;case"link":Se();break;case"unlink":O("unlink");break;case"footnote":we();break;case"undo":O("undo");break;case"redo":O("redo");break;case"clear":h().focus(),document.execCommand("removeFormat"),document.execCommand("formatBlock",!1,"p"),L();break}}function ve(){let e=h(),t=window.getSelection();if(!t.rangeCount)return[];let n=t.getRangeAt(0),o=[];for(let a of e.children)n.intersectsNode(a)&&o.push(a);if(o.length===0){let a=et();a&&a.parentNode===e&&o.push(a)}return o}function ft(e){h().focus();let t=ve();if(t.length!==0){for(let n of t){let o=parseFloat(n.style.marginLeft)||0,a=Math.max(0,o+e*2);n.style.marginLeft=a?a+"em":""}L()}}function ye(e){let t=e.trim();return t?/^(https?:|mailto:|#|\/)/i.test(t)?t:/^[\w.+-]+@[\w.-]+\.\w+$/.test(t)?"mailto:"+t:"https://"+t:""}function Se(){h().focus();let t=window.getSelection(),n=t.rangeCount&&!t.getRangeAt(0).collapsed,o=window.prompt("Link URL:","https://");if(o==null)return;let a=ye(o);if(a){if(n)document.execCommand("createLink",!1,a);else{let s=window.prompt("Link text:",a)||a;document.execCommand("insertHTML",!1,`<a href="${a.replace(/"/g,"&quot;")}">${s.replace(/</g,"&lt;")}</a>`)}L()}}function we(){h().focus();let t="fn"+A();document.execCommand("insertHTML",!1,`<sup class="fn-ref" data-fn="${t}" contenteditable="false">?</sup>\u200B`),k().footnotes.push({id:t,text:""}),V(),S(),X(),y();let o=document.querySelector(`#fn-list textarea[data-fn="${t}"]`);o&&o.focus()}function V(){let e=h(),t=Array.from(e.querySelectorAll("sup.fn-ref")),n={},o=0;for(let s of t){let i=s.getAttribute("data-fn");i in n||(o+=1,n[i]=o),s.textContent=String(n[i])}let a=k();a.footnotes=(a.footnotes||[]).filter(s=>s.id in n)}function X(){let e=l("#footnotes-panel"),t=l("#fn-list"),n=k(),o=D(n);if(t.innerHTML="",o.length===0){e.hidden=!0;return}e.hidden=!1;for(let a of o){let s=m("div",{class:"fn-row"});s.appendChild(m("span",{class:"fn-num"},String(a.num)));let i=m("textarea",{class:"fn-text",rows:"1","data-fn":a.id,placeholder:"Footnote text\u2026"});i.value=a.text,i.disabled=v,i.addEventListener("input",()=>{let r=n.footnotes.find(c=>c.id===a.id);r&&(r.text=i.value,y()),i.style.height="auto",i.style.height=i.scrollHeight+"px"}),s.appendChild(i),v||s.appendChild(m("button",{class:"icon-btn danger",title:"Delete footnote",onclick:()=>xe(a.id)},"\u{1F5D1}")),t.appendChild(s),requestAnimationFrame(()=>{i.style.height="auto",i.style.height=i.scrollHeight+"px"})}}function xe(e){h().querySelectorAll(`sup.fn-ref[data-fn="${e}"]`).forEach(o=>o.remove());let n=k();n.footnotes=n.footnotes.filter(o=>o.id!==e),V(),S(),X(),I(),y()}var ht=null;function Q(){let e=window.getSelection();e.rangeCount&&h().contains(e.anchorNode)&&(ht=e.getRangeAt(0).cloneRange())}function Ce(){if(h().focus(),!ht)return;let e=window.getSelection();e.removeAllRanges(),e.addRange(ht)}function yt(e){Ce(),document.execCommand("insertHTML",!1,e)}var M=e=>String(e??"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;");function ke(){if(v)return;let e=window.prompt("Table size \u2014 columns x rows:","3 x 3");if(e==null)return;let t=e.split(/[x×,]/i),n=Math.min(12,Math.max(1,parseInt(t[0],10)||3)),o=Math.min(60,Math.max(1,parseInt(t[1],10)||3)),a="<table><tbody>";for(let s=0;s<o;s++){a+="<tr>";for(let i=0;i<n;i++){let r=s===0?"th":"td";a+=`<${r}><br></${r}>`}a+="</tr>"}a+="</tbody></table><p><br></p>",h().focus(),document.execCommand("insertHTML",!1,a),L()}function Wt(){let e=et()||window.getSelection().anchorNode||null,t=h();for(;e&&e!==t;){if(e.tagName==="TABLE")return e;e=e.parentNode}let o=window.getSelection().anchorNode;for(;o&&o!==t;){if(o.tagName==="TABLE")return o;o=o.parentNode}return null}function Le(){let e=window.getSelection().anchorNode,t=h();for(;e&&e!==t;){if(e.tagName==="TD"||e.tagName==="TH")return e;e=e.parentNode}return null}function Ie(e){let t=Wt();if(!t)return;let n=Le(),o=n?n.parentNode:null,a=n&&o?Array.from(o.children).indexOf(n):0,s=Array.from(t.querySelectorAll("tr"));if(e==="row-after"&&o){let i=document.createElement("tr");Array.from(o.children).forEach(()=>{let r=document.createElement("td");r.innerHTML="<br>",i.appendChild(r)}),o.after(i)}else if(e==="col-after")s.forEach(i=>{let r=i.children[a],c=r&&r.tagName==="TH",d=document.createElement(c?"th":"td");d.innerHTML="<br>",r?r.after(d):i.appendChild(d)});else if(e==="row-del"&&o)s.length>1&&o.remove();else if(e==="col-del")s.forEach(i=>{i.children.length>1&&i.children[a]&&i.children[a].remove()});else if(e==="header"){let i=s[0];if(i){let r=i.children[0]&&i.children[0].tagName==="TD";Array.from(i.children).forEach(c=>{let d=document.createElement(r?"th":"td");d.innerHTML=c.innerHTML,c.replaceWith(d)})}}else e==="delete"&&t.remove();L(),setTimeout(P,0)}function P(){let e=l("#table-toolbar");if(!e)return;let t=!v&&document.activeElement===h()?Wt():null;if(!t){e.hidden=!0;return}let n=t.getBoundingClientRect();e.hidden=!1,e.style.top=Math.max(6,n.top-34)+"px",e.style.left=Math.min(window.innerWidth-e.offsetWidth-8,n.left)+"px"}function Ee(e){let t=String(e||"").trim();return/^\s*javascript:/i.test(t)?"":t}function Te(){if(v)return;Q();let e=window.prompt("Image URL:","https://");if(e==null)return;let t=Ee(e);if(!t)return;let n=window.prompt("Alt text (a short description, for accessibility & export):","")||"";yt(`<img src="${M(t)}" alt="${M(n)}">`),L()}function Ae(){v||(Q(),l("#image-file").value="",l("#image-file").click())}function Me(e,t){return new Promise((n,o)=>{let a=new FileReader;a.onerror=o,a.onload=()=>{let s=new Image;s.onerror=o,s.onload=()=>{let{width:i,height:r}=s,c=Math.min(1,t/Math.max(i,r));i=Math.round(i*c),r=Math.round(r*c);let d=document.createElement("canvas");d.width=i,d.height=r,d.getContext("2d").drawImage(s,0,0,i,r);let p=e.type==="image/png"?"image/png":"image/jpeg";n(d.toDataURL(p,.85))},s.src=a.result},a.readAsDataURL(e)})}async function $e(e){let t=e.target.files&&e.target.files[0];if(t)try{let n=await Me(t,1200),o=window.prompt("Alt text (a short description):",t.name.replace(/\.[^.]+$/,""))||"";yt(`<img src="${n}" alt="${M(o)}">`),L(),n.length>6e5&&window.alert("Heads up: this image is fairly large and is embedded directly in the note, which increases its size and sync time. For big images, consider hosting them and using \u2018Image by URL\u2019 instead.")}catch{window.alert("Sorry, that image couldn't be processed.")}}function H(){S();let e=u.citationStyle==="numbered"?"numbered":"author-date",t={};_(u).forEach((o,a)=>{t[o]=a+1});let n={};(u.sources||[]).forEach(o=>{n[o.id]=o}),h().querySelectorAll(".cite").forEach(o=>{let a=o.getAttribute("data-src"),s=o.getAttribute("data-loc")||"",i=n[a];if(!i){o.textContent=e==="numbered"?"[?]":"(source removed)";return}o.textContent=$(i,e,t[a],s)})}function Ne(e,t){let n=u.citationStyle==="numbered"?"numbered":"author-date",o;if(n==="numbered")o=`<sup class="cite" data-src="${M(e)}" data-loc="${M(t)}" contenteditable="false">[?]</sup>`;else{let a=(u.sources||[]).find(i=>i.id===e),s=$(a,n,0,t);o=`<span class="cite" data-src="${M(e)}" data-loc="${M(t)}" contenteditable="false">${C(s)}</span>`}yt(o+"\u200B"),H(),S(),I(),y()}var gt="manage";function jt(e){gt=e||"manage",l("#sources-title").textContent=gt==="pick"?"Insert citation \u2014 choose a source":"Sources",l("#citation-style").value=u.citationStyle==="numbered"?"numbered":"author-date",l("#source-form").hidden=!0,l("#sources-modal").hidden=!1,St(),tt()}function bt(){l("#sources-modal").hidden=!0}function St(){let e=l("#sources-list");e.innerHTML="";let t=u.sources||[];if(t.length===0){e.appendChild(m("div",{class:"muted small"},"No sources yet. Add one to start citing."));return}for(let n of t){let o=m("div",{class:"src-row"}),a=[n.author,n.year?`(${n.year})`:"",n.title].filter(Boolean).join(" ");o.appendChild(m("span",{class:"src-label"},a||"Untitled source"));let s=m("div",{class:"row-actions always"});gt==="pick"&&s.appendChild(m("button",{class:"btn small",onclick:()=>Be(n.id)},"Insert")),s.appendChild(m("button",{class:"icon-btn",title:"Edit",onclick:()=>_t(n)},"\u270E")),s.appendChild(m("button",{class:"icon-btn danger",title:"Delete",onclick:()=>He(n.id)},"\u{1F5D1}")),o.appendChild(s),e.appendChild(o)}}var Re={type:"Type",author:"Author(s)",year:"Year",title:"Title",container:"Journal / Book / Site",publisher:"Publisher",volume:"Volume/Issue",pages:"Pages",url:"URL",accessed:"Accessed date"};function _t(e){let t=l("#source-form"),n=e||{id:"",type:"book"};t.hidden=!1,t.innerHTML="";let o=m("div",{class:"form-grid"});for(let i of it){let r=m("label",{class:"field"+(i==="title"||i==="author"?" wide":"")},Re[i]||i),c;i==="type"?(c=m("select",{"data-f":"type"}),["book","article","chapter","website","report","other"].forEach(d=>{let p=m("option",{value:d},d[0].toUpperCase()+d.slice(1));(n.type||"book")===d&&(p.selected=!0),c.appendChild(p)})):c=m("input",{type:"text","data-f":i,value:n[i]||""}),r.appendChild(c),o.appendChild(r)}t.appendChild(o);let a=m("div",{class:"form-bar"});a.appendChild(m("button",{class:"btn",onclick:()=>je(e?e.id:null)},"Save source")),a.appendChild(m("button",{class:"btn ghost",onclick:()=>{t.hidden=!0}},"Cancel")),t.appendChild(a);let s=t.querySelector('input[data-f="author"]');s&&s.focus()}function je(e){let t=l("#source-form"),n={id:e||"src"+A()};t.querySelectorAll("[data-f]").forEach(s=>{n[s.getAttribute("data-f")]=s.value.trim()});let o=at(n);u.sources=u.sources||[];let a=u.sources.findIndex(s=>s.id===o.id);a>=0?u.sources[a]=o:u.sources.push(o),t.hidden=!0,H(),S(),y(),St(),tt()}function He(e){window.confirm("Delete this source? In-text citations to it will show as \u2018source removed\u2019.")&&(u.sources=(u.sources||[]).filter(t=>t.id!==e),H(),S(),y(),St(),tt())}function Be(e){let t=window.prompt("Page or locator (optional, e.g. \u2018p. 42\u2019):","")||"";bt(),Ne(e,t)}function De(){u.citationStyle=l("#citation-style").value==="numbered"?"numbered":"author-date",H(),S(),y(),tt()}function tt(){let e=l("#ref-preview"),t=st(u);if(t.length===0){e.innerHTML='<div class="muted small">No citations in the text yet.</div>';return}e.innerHTML=t.map(n=>`<div class="ref-item">${C(n.text)}</div>`).join("")}function I(){let e=k(),t=J(e),n=N(u),o=Math.max(1,Math.round(n/de));l("#stat-chapter").textContent=`${t.toLocaleString()} words in this chapter`,l("#stat-total").textContent=`${n.toLocaleString()} total`,l("#stat-reading").textContent=`~${o} min read`,b=dt(b,n,R());let a=Nt(b,n,R()),s=Number(b.sessionGoal)||0;l("#stat-session").textContent=s?`Today: ${a.toLocaleString()} / ${s.toLocaleString()}`:`Today: ${a.toLocaleString()} words`;let i=s?Math.min(100,Math.round(a/s*100)):0;l("#session-bar").style.width=i+"%",l("#session-bar").classList.toggle("done",s>0&&a>=s)}function wt(){l("#target-manuscript").value=b.manuscriptTarget||"",l("#target-session").value=b.sessionGoal||"";let e=N(u),t=Number(b.manuscriptTarget)||0,n=t?Math.min(100,Math.round(e/t*100)):0;l("#manuscript-bar").style.width=n+"%",l("#manuscript-pct").textContent=t?`${n}% of ${t.toLocaleString()}`:"no target set"}function Ht(){let e=parseInt(l("#target-manuscript").value,10),t=parseInt(l("#target-session").value,10);b.manuscriptTarget=Number.isFinite(e)&&e>0?e:0,b.sessionGoal=Number.isFinite(t)&&t>0?t:0,Ft(),wt(),I()}function xt(){document.body.classList.toggle("focus-mode",!!f.focusMode),document.body.classList.toggle("typewriter",!!f.typewriter),l("#btn-focus").classList.toggle("on",!!f.focusMode),l("#btn-typewriter").classList.toggle("on",!!f.typewriter),zt(),f.focusMode?Ct():Jt()}var Bt={tight:"0.15em",normal:"0.65em",loose:"1.1em"};function zt(){let e=h();if(!e)return;let t=f.lineSpacing||1.5,n=Bt[f.paraSpacing]||Bt.tight;e.style.setProperty("--ls",t),e.style.setProperty("--para-gap",n),e.classList.toggle("first-indent",!!f.firstLineIndent),document.querySelectorAll('#format-menu .menu-seg[data-pref="lineSpacing"] button').forEach(a=>a.classList.toggle("on",String(t)===a.dataset.val)),document.querySelectorAll('#format-menu .menu-seg[data-pref="paraSpacing"] button').forEach(a=>a.classList.toggle("on",(f.paraSpacing||"tight")===a.dataset.val));let o=l('#format-menu .menu-toggle[data-pref="firstLineIndent"]');o&&o.classList.toggle("on",!!f.firstLineIndent)}function ut(e,t){f[e]=t,vt(),zt(),Z()}function Dt(){f.focusMode=!f.focusMode,vt(),xt(),Z()}function Ue(){f.typewriter=!f.typewriter,vt(),xt(),f.typewriter&&kt()}function et(){let e=window.getSelection();if(!e.rangeCount)return null;let t=e.getRangeAt(0).startContainer;t.nodeType===3&&(t=t.parentNode);let n=h();for(;t&&t!==n&&t.parentNode!==n;)t=t.parentNode;return t&&t!==n?t:null}function Jt(){h().querySelectorAll(".cur-block").forEach(e=>e.classList.remove("cur-block"))}function Ct(){Jt();let e=et();e&&e.classList&&e.classList.add("cur-block")}function kt(){let e=window.getSelection();if(!e.rangeCount)return;let n=e.getRangeAt(0).cloneRange().getBoundingClientRect();if(!n||n.top===0&&n.bottom===0){let i=et();i&&(n=i.getBoundingClientRect())}if(!n)return;let o=l("#editor-scroll"),a=o.clientHeight/2,s=n.top-o.getBoundingClientRect().top-a;o.scrollTop+=s}function Ut(){K&&(P(),document.activeElement===h()&&(f.focusMode&&Ct(),f.typewriter&&kt()))}function Oe(){return u.chapters[0]&&u.chapters[0].title,"Manuscript"}function pt(e,t,n){let o=new Blob([t],{type:n}),a=URL.createObjectURL(o),s=m("a",{href:a,download:e});document.body.appendChild(s),s.click(),setTimeout(()=>{document.body.removeChild(s),URL.revokeObjectURL(a)},0)}function Pe(e){S();let t=Oe();e==="md"?pt("manuscript.md",At(u,t),"text/markdown"):e==="txt"?pt("manuscript.txt",Mt(u,t),"text/plain"):e==="html"&&pt("manuscript.html",$t(u,t),"text/html"),j()}function j(e){document.querySelectorAll(".menu.open").forEach(t=>{t!==e&&t.classList.remove("open")})}function Fe(){let e=l("#app");e.innerHTML=`
  <aside id="sidebar">
  ...
  </div>`,l("#btn-add").addEventListener("click",me),l("#chapter-title-input").addEventListener("input",n=>{let o=k();o&&(o.title=n.target.value,E(),y())}),document.querySelectorAll(".fmt").forEach(n=>{n.addEventListener("mousedown",o=>o.preventDefault()),n.addEventListener("click",()=>{n.dataset.cmd?O(n.dataset.cmd):n.dataset.block?O("formatBlock",n.dataset.block):n.dataset.action&&be(n.dataset.action)})});let t=h();t.addEventListener("input",L),t.addEventListener("keyup",()=>{f.typewriter&&kt()}),t.addEventListener("click",Ut),t.addEventListener("keydown",n=>{n.key==="Tab"&&(n.preventDefault(),ft(n.shiftKey?-1:1))}),document.addEventListener("selectionchange",Ut),l("#btn-format").addEventListener("click",n=>{n.stopPropagation(),j(l("#format-menu")),l("#format-menu").classList.toggle("open")}),l("#format-menu").addEventListener("click",n=>n.stopPropagation()),document.querySelectorAll('#format-menu .menu-seg[data-pref="lineSpacing"] button').forEach(n=>n.addEventListener("click",()=>ut("lineSpacing",parseFloat(n.dataset.val)))),document.querySelectorAll('#format-menu .menu-seg[data-pref="paraSpacing"] button').forEach(n=>n.addEventListener("click",()=>ut("paraSpacing",n.dataset.val))),l('#format-menu .menu-toggle[data-pref="firstLineIndent"]').addEventListener("click",()=>ut("firstLineIndent",!f.firstLineIndent)),l("#btn-insert").addEventListener("click",n=>{n.stopPropagation(),Q(),j(l("#insert-menu")),l("#insert-menu").classList.toggle("open")}),document.querySelectorAll("#insert-menu button").forEach(n=>n.addEventListener("click",()=>{let o=n.dataset.insert;j(),o==="table"?ke():o==="image-url"?Te():o==="image-upload"?Ae():o==="citation"?(Q(),jt("pick")):o==="sources"&&jt("manage")})),l("#image-file").addEventListener("change",$e),document.querySelectorAll("#table-toolbar button").forEach(n=>{n.addEventListener("mousedown",o=>o.preventDefault()),n.addEventListener("click",()=>Ie(n.dataset.tbl))}),l("#editor-scroll").addEventListener("scroll",P),window.addEventListener("resize",P),l("#sources-close").addEventListener("click",bt),l("#sources-modal").addEventListener("click",n=>{n.target.id==="sources-modal"&&bt()}),l("#citation-style").addEventListener("change",De),l("#src-add").addEventListener("click",()=>_t(null)),l("#target-manuscript").addEventListener("change",Ht),l("#target-session").addEventListener("change",Ht),l("#btn-focus").addEventListener("click",Dt),l("#exit-focus").addEventListener("click",Dt),l("#btn-typewriter").addEventListener("click",Ue),l("#btn-export").addEventListener("click",n=>{n.stopPropagation(),j(l("#export-menu")),l("#export-menu").classList.toggle("open")}),document.querySelectorAll("#export-menu button").forEach(n=>n.addEventListener("click",()=>Pe(n.dataset.export))),document.addEventListener("click",j),document.addEventListener("keydown",n=>{(n.metaKey||n.ctrlKey)&&n.key.toLowerCase()==="s"&&(n.preventDefault(),S(),Pt())})}function qe(e,t){b=t&&typeof t=="object"?Object.assign({},t):{},u=z(e),v=!!w.default.locked,f=w.default.extensionMeta&&typeof w.default.extensionMeta=="object"?w.default.extensionMeta:{},document.body.classList.toggle("locked",v),qt();let n=JSON.stringify(b.session||null);b=dt(b,N(u),R()),JSON.stringify(b.session||null)!==n&&Ft()}function Ot(){Fe(),w.default.initialize({debounceSave:350}),w.default.subscribe((e,t)=>{if(e===mt){b=t&&typeof t=="object"?Object.assign({},t):b,wt(),I();return}mt=rt(z(e)),K=!0,qe(e,t)}),setTimeout(()=>{K||(K=!0,u=z(""),u.chapters[0].html="<p>This is a standalone preview. Inside Standard Notes your manuscript loads here automatically.</p>",qt())},1200)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ot):Ot();})();
